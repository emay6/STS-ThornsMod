...
public class ThornsCharacter extends CustomPlayer {
    //Stats
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass THORNS_CHARACTER;
        ...
        private static final String CHAR_SELECT_BUTTON = ThornsMod.characterPath("select/button.png");
        private static final String CHAR_SELECT_PORTRAIT = ThornsMod.characterPath("select/portrait.png");

        //Character card images
        private static final String BG_ATTACK = ThornsMod.characterPath("cardback/bg_attack.png");
        private static final String BG_ATTACK_P = ThornsMod.characterPath("cardback/bg_attack_p.png");
        private static final String BG_SKILL = ThornsMod.characterPath("cardback/bg_skill.png");
        private static final String BG_SKILL_P = ThornsMod.characterPath("cardback/bg_skill_p.png");
        private static final String BG_POWER = ThornsMod.characterPath("cardback/bg_power.png");
        private static final String BG_POWER_P = ThornsMod.characterPath("cardback/bg_power_p.png");
        private static final String ENERGY_ORB = ThornsMod.characterPath("cardback/energy_orb.png");
        private static final String ENERGY_ORB_P = ThornsMod.characterPath("cardback/energy_orb_p.png");
        private static final String SMALL_ORB = ThornsMod.characterPath("cardback/small_orb.png");
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new ThornsCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }


    //In-game images
    private static final String SHOULDER_1 = ThornsMod.characterPath("shoulder.png"); //Shoulder 1 and 2 are used at rest sites.
    private static final String SHOULDER_2 = ThornsMod.characterPath("shoulder2.png");
    private static final String CORPSE = ThornsMod.characterPath("corpse.png"); //Corpse is when you die.

    //Textures used for the energy orb
    private static final String[] orbTextures = {
            ThornsMod.characterPath("energyorb/layer1.png"), //When you have energy
            ThornsMod.characterPath("energyorb/layer2.png"),
            ThornsMod.characterPath("energyorb/layer3.png"),
            ThornsMod.characterPath("energyorb/layer4.png"),
            ThornsMod.characterPath("energyorb/layer5.png"),
            ThornsMod.characterPath("energyorb/cover.png"), //"container"
            ThornsMod.characterPath("energyorb/layer1d.png"), //When you don't have energy
            ThornsMod.characterPath("energyorb/layer2d.png"),
            ThornsMod.characterPath("energyorb/layer3d.png"),
            ThornsMod.characterPath("energyorb/layer4d.png"),
            ThornsMod.characterPath("energyorb/layer5d.png")
    };
    ...
    public ThornsCharacter() {
        super(getNames()[0], Meta.THORNS_CHARACTER,
                new CustomEnergyOrb(orbTextures, ThornsMod.characterPath("energyorb/vfx.png"), layerSpeeds), //Energy Orb
                new SpriterAnimation(ThornsMod.characterPath("animation/default.scml"))); //Animation
